                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td style="width: 50px; text-align: center;"><b class="idx"> <?php echo "{$venda['IdVenda']}"; ?> </b><br><br><code></code></td>
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlushExample-<?php echo "{$venda['IdVenda']}"; ?>  ">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="flush-headingOne-<?php echo $venda['IdVenda']; ?>">
                                                <button style="background-color: #fff;" class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
